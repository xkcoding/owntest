package com.xkcoding.test.test23;
 ...
 * @description: 测试 disruptor 单生产者 单消费者模型
 * @author: yangkai.shen
...
public class Test23 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Disruptor<ExportEvent> disruptor = new Disruptor<>(factory, ringBufferSize, DaemonThreadFactory.INSTANCE, ProducerType.SINGLE, new YieldingWaitStrategy());
